globalThis.__timing__.logStart('Load chunks/build/VList-B7h15kBl');import { g as genericComponent, l as provideTheme, a as useProxiedModel, z as provideDefaults, r as getCurrentInstance$1, V as focusChild, p as propsFactory, I as IconValue, x as makeThemeProps, O as EventProp, Y as consoleError, B as isPrimitive, a5 as getPropertyFromItem, o as omit, K as wrapInArray, a6 as defineComponent$1, a7 as deprecate, c as convertToUnit } from '../virtual/entry.mjs';
import { g as useBackgroundColor, o as useBorder, c as useDensity, d as useDimension, G as useElevation, f as useRounded, u as useRender, R as Ripple, H as useLink, p as useVariant, A as makeVariantProps, B as makeTagProps, m as makeRoundedProps, I as makeElevationProps, l as makeDimensionProps, n as makeDensityProps, k as makeComponentProps, D as makeBorderProps, J as makeRouterProps, i as VDefaultsProvider, r as genOverlays, a as VIcon, h as useTextColor } from './VBtn-BK5zdqJr.mjs';
import { M as MaybeTransition } from './forwardRefs-BQag-fAc.mjs';
import { c as createSimpleFunctional, a as VAvatar } from './VMenu-5yZPJeqd.mjs';
import { g as VExpandTransition } from './autofocus-iHZUSa1f.mjs';
import { toRef, useId, watch, shallowRef, ref, computed, toRaw, toValue, provide, inject, nextTick, createVNode, normalizeStyle, normalizeClass, withDirectives, createElementVNode, vShow, mergeProps, Fragment, toDisplayString, readonly } from 'vue';
	...
	setup(props, { attrs, slots, emit }) {
		...
		useRender(() => {
			...
			return withDirectives(createVNode(Tag, mergeProps(link.linkProps, {
				...
				}, { default: () => [slots.prepend?.(slotProps.value)] }), createElementVNode("div", { "class": "v-list-item__spacer" }, null)]),
				...
				}, { default: () => [slots.append?.(slotProps.value)] }), createElementVNode("div", { "class": "v-list-item__spacer" }, null)])
...
var VListSubheader = genericComponent()({
	...
	setup(props, { slots }) {
		...
		useRender(() => {
			...
			}, { default: () => [hasText && createElementVNode("div", { "class": "v-list-subheader__text" }, [slots.default?.() ?? props.title])] });
		});
		return {};
	}
});
...
var VDivider = genericComponent()({
	...
	setup(props, { attrs, slots }) {
		...
		useRender(() => {
			...
			return createElementVNode("div", { "class": normalizeClass(["v-divider__wrapper", {
...
export { VList as V, VListItem as a };;globalThis.__timing__.logEnd('Load chunks/build/VList-B7h15kBl');
//# sourceMappingURL=VList-B7h15kBl.mjs.map
