import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { inject as inject$1, computed, toRef, watch, onScopeDispose, reactive, watchEffect, shallowRef, warn, toValue, Fragment, capitalize, readonly, hasInjectionContext, defineComponent as defineComponent$1, ref, toRaw, getCurrentInstance as getCurrentInstance$1, provide, unref, effectScope, createVNode, mergeProps, createElementVNode, isRef, normalizeClass, createElementBlock, cloneVNode, h, defineAsyncComponent, shallowReactive, Suspense, createApp, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRefs } from 'vue';
import { q as hasProtocol, s as isScriptProtocol, n as joinURL, w as withQuery, t as defu, v as sanitizeStatusCode, x as getContext, c as createError$1, y as withLeadingSlash, z as parseURL, $ as $fetch$1, A as baseURL, B as appendHeader, C as getRequestHeaders, D as createHooks, E as executeAsync, F as getHeader, G as toRouteMatcher, H as createRouter$1, I as withoutTrailingSlash, J as withoutBase } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-DuMPRUXv.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./login-DvMuOBVx.mjs')
  },
  {
    name: "decks-new",
    path: "/decks/new",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./new-Cuu_5KLE.mjs')
  },
  {
    name: "decks-deckId-edit",
    path: "/decks/:deckId()/edit",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./edit-DP3tzjf0.mjs')
  },
  {
    name: "decks-deckId",
    path: "/decks/:deckId()",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-DIrlsujt.mjs')
  },
  {
    name: "decks-deckId-cards-new",
    path: "/decks/:deckId()/cards/new",
    component: () => import('./new-BlSLYbRg.mjs')
  },
  {
    name: "decks-deckId-cards",
    path: "/decks/:deckId()/cards",
    component: () => import('./index-nBHsPuAl.mjs')
  },
  {
    name: "decks-deckId-cards-cardId-edit",
    path: "/decks/:deckId()/cards/:cardId()/edit",
    component: () => import('./edit-DcWwDp3L.mjs')
  }
];
...
class DefaultRefreshHandler {
  ...
  visibilityHandler() {
    if (this.config?.enableOnWindowFocus && (void 0).visibilityState === "visible" && this.auth?.data.value) {
      this.auth.refresh();
    }
  }
}
...
function vuetifyConfiguration() {
  const options = { "theme": { "defaultTheme": "light", "themes": { "light": { "colors": { "primary": "#4CAF50", "mnemo-primary": "#2563EB", "mnemo-secondary": "#64748B", "mnemo-outline": "#CBD5E1" } } } }, "ssr": true };
  return options;
}
  ...
  function resolve(fn) {
    return computed(() => fn().map((rule) => {
      ...
      if (ruleName !== null) {
        ...
        return aliases2[ruleName]?.(...ruleParams);
      } else {
        return rule;
      }
    }));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-2qGFRu86.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DR8PSoeM.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Czb1Elex.mjs'));
...
export { getNextElement as $, useDisplay as A, filterInputAttrs as B, callEvent as C, clamp as D, EventProp as E, useLocale as F, getCurrentInstanceName as G, useRtl as H, IconValue as I, standardEasing as J, useRules as K, useToggleScope as L, pick as M, acceleratedEasing as N, deceleratedEasing as O, PREFERS_REDUCED_MOTION as P, useTheme as Q, pickWithRest as R, isObject as S, destructComputed as T, CircularBuffer as U, defer as V, templateRef as W, matchesSelector as X, focusableChildren as Y, isClickInsideElement as Z, _export_sfc as _, useNuxtApp as a, includes as a0, isCssColor as a1, isParsableColor as a2, parseColor as a3, hasLightForeground as a4, findChildrenWithProvide as a5, consoleWarn as a6, useIcon as a7, flattenFragments as a8, hasEvent as a9, onlyDefinedProps as aa, useRuntimeConfig as b, nuxtLinkDefaults as c, useAuth as d, entry_default as default, breakpoints as e, useRoute as f, genericComponent as g, useProxiedModel as h, getCurrentInstance as i, consoleError as j, keys as k, defineComponent as l, provideTheme as m, navigateTo as n, deprecate as o, propsFactory as p, convertToUnit as q, resolveRouteObject as r, makeThemeProps as s, provideDefaults as t, useRouter as u, focusChild as v, wrapInArray as w, isPrimitive as x, getPropertyFromItem as y, omit as z };
