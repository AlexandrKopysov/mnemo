globalThis.__timing__.logStart('Load chunks/build/autofocus-iHZUSa1f');import { a as useProxiedModel, s as getCurrentInstanceName, g as genericComponent, l as provideTheme, v as useRtl, p as propsFactory, I as IconValue, x as makeThemeProps, O as EventProp, Q as pick, R as useLocale, S as useRules, K as wrapInArray, r as getCurrentInstance$1, C as useToggleScope, c as convertToUnit, P as PREFERS_REDUCED_MOTION, d as callEvent, T as standardEasing } from '../virtual/entry.mjs';
import { c as useDensity, d as useDimension, u as useRender, e as useLoader, f as useRounded, g as useBackgroundColor, h as useTextColor, L as LoaderSlot, i as VDefaultsProvider, m as makeRoundedProps, j as makeLoaderProps, k as makeComponentProps, l as makeDimensionProps, n as makeDensityProps, a as VIcon } from './VBtn-BK5zdqJr.mjs';
import { n as nullifyTransforms, a as animate, M as MaybeTransition, m as makeTransitionProps$1 } from './forwardRefs-BQag-fAc.mjs';
import { toRef, useId, shallowRef, computed, createElementVNode, normalizeStyle, normalizeClass, createVNode, ref, watch, mergeProps, withDirectives, vShow, Fragment, unref, inject, nextTick, TransitionGroup, Transition, h } from 'vue';
...
var VCounter = genericComponent()({
	...
	setup(props, { slots }) {
		...
		useRender(() => createVNode(MaybeTransition, { "transition": props.transition }, { default: () => [withDirectives(createElementVNode("div", {
...
var VField = genericComponent()({
	...
	setup(props, { attrs, emit, slots }) {
		...
		function onClick(e) {
			if (e.target !== (void 0).activeElement) e.preventDefault();
		}
		useRender(() => {
			...
			return createElementVNode("div", mergeProps({
				...
				createElementVNode("div", { "class": "v-field__overlay" }, null),
				...
				hasClear && createVNode(VExpandXTransition, { "key": "clear" }, { default: () => [withDirectives(createElementVNode("div", {
				...
				}, [isOutlined && createElementVNode(Fragment, null, [
					createElementVNode("div", { "class": "v-field__outline__start" }, null),
					hasFloatingLabel.value && createElementVNode("div", { "class": "v-field__outline__notch" }, [createVNode(VFieldLabel, mergeProps({
						"ref": floatingLabelRef,
						"floating": true
					}, floatingLabelProps.value), { default: () => [label()] })]),
					createElementVNode("div", { "class": "v-field__outline__end" }, null)
	...
	setup(props, { attrs, slots, emit }) {
		...
		useRender(() => {
			...
			return createElementVNode("div", {
				...
				slots.default && createElementVNode("div", { "class": "v-input__control" }, [slots.default?.(slotProps.value)]),
				hasAppend && createElementVNode("div", {
					"key": "append",
				...
				hasDetails.value && createElementVNode("div", {
					"id": messagesId.value,
...
export { VInput as V, useAutocomplete as a, VField as b, VCounter as c, useAutofocus as d, makeVInputProps as e, makeAutocompleteProps as f, VExpandTransition as g, makeVFieldProps as m, useFocus as u };;globalThis.__timing__.logEnd('Load chunks/build/autofocus-iHZUSa1f');
//# sourceMappingURL=autofocus-iHZUSa1f.mjs.map
