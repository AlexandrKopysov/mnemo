globalThis.__timing__.logStart('Load chunks/build/error-404-8cEr2qiW');import { u as useHead$1 } from './head-BJRQEgtj.mjs';
import { _ as _plugin_vue_export_helper_default, ab as NuxtLink } from '../virtual/entry.mjs';
...
//#region node_modules/.pnpm/nuxt@4.5.1_@babel+plugin-sy_b942fa8e71d932aca3f66540b9469867/node_modules/nuxt/dist/app/components/error-404.vue
var _sfc_main = {
	__name: "error-404",
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-247883cf><div class="max-w-520px text-center" data-v-247883cf><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-247883cf>${ssrInterpolate(__props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-247883cf>${ssrInterpolate(__props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-247883cf>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-247883cf>`);
...
_sfc_main.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.5.1_@babel+plugin-sy_b942fa8e71d932aca3f66540b9469867/node_modules/nuxt/dist/app/components/error-404.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var error_404_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-247883cf"]]);

export { error_404_default as default };;globalThis.__timing__.logEnd('Load chunks/build/error-404-8cEr2qiW');
//# sourceMappingURL=error-404-8cEr2qiW.mjs.map
