globalThis.__timing__.logStart('Load chunks/routes//renderer');import { u as useRuntimeConfig, h as encodePath, i as buildAssetsURL, j as publicAssetsURL, k as defineRenderHandler, l as getQuery, f as createError, d as destr, m as getRouteRules, n as relative, o as joinURL, q as getResponseStatusText, v as getResponseStatus, b as useNitroApp } from '../_/nitro.mjs';
...
const getServerEntry = () => import('../virtual/entry.mjs').then(function (n) { return n.af; }).then((r) => r.default || r);
...
const entryFileName = "CWb9A5PR.js";
...
export { VueResolver as V, headSymbol as h, injectHead as i, renderer as r };;globalThis.__timing__.logEnd('Load chunks/routes//renderer');
